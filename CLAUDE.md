...
- Python 3.10–3.13; local env is 3.13. Start new modules with `from __future__ import annotations`.
- `snake_case` modules/functions, `PascalCase` classes; prefer `pathlib.Path`; keep explicit type hints on public paths.
- No committed formatter/linter — match surrounding style, avoid unrelated reformatting.
